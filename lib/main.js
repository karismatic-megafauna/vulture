...
if (!process.env.TEST) {
  if (process.argv[2]) {
    run(require(path.join(process.cwd(), process.argv[2]))).then(filter(excludeIfContains('test'))).then(filter(excludeIfContains('.md'))).then(filter(excludeIfContains('.princess'))).then(filter(excludeIfContains('.scss'))).then(filter(excludeIfContains('.svg'))).then(filter(excludeIfContains('.png'))).then(filter(excludeIfContains('.ttf'))).then(filter(excludeIfContains('.woff'))).then(filter(excludeIfContains('.woff2'))).then(filter(excludeIfContains('.eot'))).then(map(debug));
  } else {
    run(defaultConfig).then(filter(excludeIfContains('test'))).then(filter(excludeIfContains('.md'))).then(filter(excludeIfContains('.princess'))).then(filter(excludeIfContains('.scss'))).then(filter(excludeIfContains('.svg'))).then(filter(excludeIfContains('.png'))).then(filter(excludeIfContains('.ttf'))).then(filter(excludeIfContains('.woff'))).then(filter(excludeIfContains('.woff2'))).then(filter(excludeIfContains('.eot'))).then(map(debug));
  }
}
